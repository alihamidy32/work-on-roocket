      ...
      <div class="card-part">
        <div class="card-container">
          <div class="img-container">
            ...
            <img src="@/assets/php.png" alt="" class="img">
            <span class="h">
              تکمیل ضبط
            </span>
          </div>
        <div class="card-section">
          <div class="card-part-a">
            <span class="titr">
              آموزش PHP
            </span>
            <p class="paragraf">
              در دوره آموزش php ما سعی می کنیم php را بشکل جامع و کامل و کاملا رایگان به شما آموزش دهیم تا با استفاده از php بتوانید سایت های خود را بسازید.
            </p>
          </div>
          <div class="container-b">
          <div class="card-part-b">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor" class="w-5 c-5 h-5">
              ...
              <div class="c">
                <div class="heart">
                  <div class="clock">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="w-5 f-5 h-5">
...
.h{
  ...
  color: #ffff;
  background-color: rgba(117, 105, 105, 0.582);
  border-radius: 4px;
}
.card-section{
  display: flex;
...
.card-part-c{
  ...
  background-color: rgba(211, 211, 211, 0.787);
